...
const productsData: Product[] = [
  ...
  },
  {
    ...
    features: ['100支装', '透明卫生盒', '防尘设计', '100%有机棉', '双端设计'],
    featuresEn: ['100-count', 'Clear hygienic box', 'Dust-proof design', '100% Organic Cotton', 'Double-ended design'],
    specifications: {
      '包装数量': '100支/盒',
      '材质': '100%天然有机棉',
      '设计': '双端设计（圆端+尖端）',
    ...
    specificationsEn: {
      'Package Quantity': '100-count per pack',
      'Material': '100% natural organic cotton',
      'Design': 'Double-ended (rounded + pointed)',
      'Usage': 'Personal care, household cleaning',
      'Features': 'Lint-free, dust-proof'
    },
    inStock: true,
    rating: 4.7,
    reviewCount: 203,
  ...
  },
  {
    ...
    features: ['30支装', '透明卫生盒', '旅行便携', '100%棉质', '迷你尺寸'],
    featuresEn: ['30-count', 'Clear hygienic box', 'Travel portable', '100% Cotton', 'Mini size'],
    specifications: {
      '包装数量': '30支/盒',
      '材质': '100%棉质',
      '设计': '迷你便携尺寸',
    ...
    specificationsEn: {
      'Package Quantity': '30-count per pack',
      'Material': '100% cotton',
      'Design': 'Mini portable size',
      'Usage': 'Travel care, daily use',
      'Features': 'Lightweight, dust-proof'
    },
    inStock: true,
    rating: 4.5,
    reviewCount: 156,
