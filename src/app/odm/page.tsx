            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                <div className="relative">
                  <WebPImage
                    ...
                    width={1200}
                    height={800}
                    className="w-full h-[400px] object-contain rounded-2xl shadow-2xl bg-gray-100"
                  />
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                <div className="lg:order-2">
                  <WebPImage
                    ...
                    width={1200}
                    height={800}
                    className="w-full h-[350px] object-contain rounded-2xl shadow-2xl bg-gray-100"
                  />
                </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                <div className="relative">
                  <WebPImage
                    ...
                    width={1500}
                    height={1000}
                    className="w-full h-[450px] object-contain rounded-2xl shadow-2xl bg-gray-100"
                  />
                </div>
              <div className="space-y-8">
                <div className="flex items-center mb-6">
